      ...
      <el-main>
        <div class="bg-white container mx-auto p-10" style="min-height: 600px">
          ...
          <el-container class="mt-8 mb-2">
            ...
            <el-text style="margin-left: 20px">来源：本网</el-text>
          ...
          <el-container class="justify-center mx-32">
            <div :style="{ fontSize: newSize.fontSize }">
              <div
                style="
                  display: flex;
                ...
                "
              >
                <!-- <h1 style="margin-bottom: 20px;">网站声明</h1> -->
              </div>

              <div>
                &nbsp; &nbsp; &nbsp;
                &nbsp;本网站内容由中国电建集团昆明勘测设计研究院有限公司以及相关单位提供。任何媒体、互联网站和商业机构不得利用本网站发布的内容进行商业性的原版原式地转载，也不得歪曲和篡改本网站所发布的内容。本网站所涉及到的版权归本网站所属。
                <br />
                &nbsp; &nbsp; &nbsp;
                &nbsp;本网站提供的资料如与相关纸质文本不符，以纸质文本为准。
                <br />
                &nbsp; &nbsp; &nbsp;
                &nbsp;任何媒体或互联网站不得檀自转载本网站由其他单位提供的信息和服务内容，如需转载，必须与相应提供单位直接联系获得合法授权.
                <br />
                &nbsp; &nbsp; &nbsp;
                &nbsp;中国电建集团昆明勘测设计研究院有限公司版权所有，对违反版权者保留一切追索权利。
                <br />
                <br />
                &nbsp; &nbsp; &nbsp; &nbsp;备案序号: 粤XX备XXXXXXXX号。
              </div>
...
<style scoped>
.mb-10 tr .border:first-child {
  padding: 10px;
  text-align: right;
}

.mb-10 tr .border:last-child {
  /* height: 40px; */
  padding: 10px;
}
</style>
